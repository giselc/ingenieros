 ...
 * @author Gisel
 */
public class ObservacionArmamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("id")!= null){ //alta o modficacion
                ...
                int idEscribiente= Integer.valueOf(request.getParameter("idEscribiente"));
                if(id==-1){ //alta
                    if(mc.agregarObservacionArmamento(idArmamento, fecha, observaciones, idEscribiente)){
                        sesion.setAttribute("mensaje", "Observación agregada correctamente.");
                    }
                    else{
                    ...
                    if(mc.modificarObservacionArmamento(id, idArmamento, fecha, observaciones, idEscribiente)){
                ...
                if(request.getParameter("elim")!= null){
                    ...
                    if(mc.eliminarObservacionArmamento(id)){
